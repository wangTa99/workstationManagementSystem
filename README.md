...
https://www.notmaker.com/detail/8525d865acb24d55890cc81245135363/gtt20260415 
...
1. 本项目主要用于学习与演示，代码以可读性为首要目标
2. 请勿直接用于生产环境或商业用途
3. 当前密码为明文存储，正式环境需替换为加密方案
4. 首次运行请确保文件上传目录已创建或在配置中修改
5. 数据库字符集建议使用 `utf8mb4`
6. 部署线上时请更新配置中的域名、端口及静态资源路径
